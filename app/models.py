...
der ipso! Bildung, Kap. 2.1.3): Das Datenmodell dieses Moduls wurde in
Zusammenarbeit mit dem KI-Werkzeug Claude (Anthropic) entwickelt
(Architekturberatung zu Tabellenstruktur und Beziehungen, Code-Generierung).
Pruefung, Anpassung und inhaltliche Verantwortung liegen beim Verfasser
(Kevin Martinez). Vollstaendige Deklaration siehe KI-Deklarationstabelle
in der Eigenstaendigkeitserklaerung der schriftlichen Dokumentation.
"""
import secrets
